...
public class Withdraw extends javax.swing.JFrame {
    ...
    public Withdraw(javax.swing.JPanel toast) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Withdraw || FundWise - Securely access your finances");
        ...
        onboarding_text.setText("Withdraw Funds");
        ...
        withdraw.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
    ...
    private void withdrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_withdrawActionPerformed
        if(amount.getText().length() > 0) {
            boolean withdraw_funds = database.withdraw(connection, this.username, Float.parseFloat(amount.getText()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Withdraw(toast).setVisible(true);
        });
    }
